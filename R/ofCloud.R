...
# test stage
regionToBaseURL_map_alpha <- c("APAC"="au-alpha.catapultsports.com", "EMEA"="eu-alpha.catapultsports.com", "America"="us-alpha.catapultsports.com")
regionToBaseURL_map_beta <- c("APAC"="au-beta.catapultsports.com", "EMEA"="eu-beta.catapultsports.com", "America"="us-beta.catapultsports.com")

# production
regionToBaseURL_map_main <- c("APAC"="openfield.catapultsports.com", "EMEA"="eu.catapultsports.com", "America"="us.catapultsports.com")
...
#'
#' @export
#' @param sRegion a region from the set \code{"APAC", "EMEA", "America"}
...
ofCloudGetStatistics<-function(credentials, params, groupby="athlete", filters, annotationStats = FALSE)
{
  ...
  for (j in seq_len(NROW(filter_df)))
  {
    ...
    stopifnot(filterJ$name %in% c("date", "period_id", "activity_id", "athlete_id", "position_id", "team_id", "athlete_group_id",
                                  ...
                                  "month_id", "day_id"))
    stopifnot(filterJ$comparison %in% c("=", "!=", ">", "<", ">=", "<="))
